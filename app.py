...
def webhook():
  ...
  rules = "These are the Group rules (this also apply for the parties and any communication channels as a group)\n-) No discrimination\n-) No religion\n-) No politics (including other countries)\n-) No spamming"
  ...
  if data['name'] != 'Wild Palm Tree':
    ...
    if 'rules!' in data['text'] :
      if random.randint(1, 10) > 8 :
        ...
        msg1 ='You know, I like you '+data['name']+', have this: https://www.youtube.com/watch?v=GaAUS0GsG_M'.format(data['name'], data['text'])
